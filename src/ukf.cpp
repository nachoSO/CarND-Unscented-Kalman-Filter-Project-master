...
void UKF::UpdateLidar(MeasurementPackage meas_package) {
  ...
  */
  ...
  S = S + R;
	...
	NIS_laser_=Update(meas_package, z_pred, S, z, Zsig, n_z);
}
...
void UKF::UpdateRadar(MeasurementPackage meas_package) {
  ...
  */
  ...
  S = S + R;
	...
	NIS_radar_=Update(meas_package, z_pred, S, z, Zsig, n_z);

}

double UKF::Update(MeasurementPackage meas_package, VectorXd z_pred, MatrixXd S, VectorXd z, MatrixXd Zsig, int n_z) {
  ...
  P_ = P_ - K*S*K.transpose();
	...
	return (meas_package.raw_measurements_-z_pred).transpose() * S.inverse() * (meas_package.raw_measurements_-z_pred);
}
